...
Board::Board() {
	...
	PropertyField* field7 = new PropertyField(NULL, "Wlochy", "Neapol", 200, new int[15, 60, 180, 540, 800, 1100], 0, 100, 100, false, PROPERTY, 6);
	fields[6] = field7;
	Field* field8 = new Field(RED_CHANCE, 7);
	fields[7] = field8;
	//Field* field9 = new Field(PROPERTY, 8);
	PropertyField* field9 = new PropertyField(NULL, "Wlochy", "Mediolan", 200, new int[15, 60, 180, 540, 800, 1100], 0, 100, 100, false, PROPERTY, 8);
	fields[8] = field9;
	//Field* field10 = new Field(PROPERTY, 9);
	PropertyField* field10 = new PropertyField(NULL, "Wlochy", "Rzym", 240, new int[20, 80, 200, 600, 900, 1200], 0, 100, 120, false, PROPERTY, 9);
	fields[9] = field10;
	...
	PropertyField* field40 = new PropertyField(NULL, "Austria", "Wieden", 800, new int[100, 400, 1200, 2800, 3400, 4000], 0, 400, 400, false, PROPERTY, 39);
	fields[39] = field40;
	...
	//karty niebieskie
	Card* blue0 = new Card(0, "Wychodzisz wolny z wiezienia. Karte nalezy zachowac do wykorzystania lub sprzedania.");
	blueCards[0] = blue0;

	Card* blue1 = new Card(1, "Wracasz do \"WIEDNIA\"");
	blueCards[1] = blue1;

	Card* blue2 = new Card(2, "Placisz za karte 20$ lub ciagniesz \"SZANSE\" z drugiego zestawu (czerwonego)");
	blueCards[2] = blue2;

	Card* blue3 = new Card(3, "Wracasz na \"START\"");
	blueCards[3] = blue3;

	Card* blue4 = new Card(4, "Idziesz do wiezienia. Nie przechodzisz przez \"START\". Nie otrzymujesz 200$.");
	blueCards[4] = blue4;

	Card* blue5 = new Card(5, "Placisz koszty leczenia w wysokosci 20$.");
	blueCards[5] = blue5;

	Card* blue6 = new Card(6, "Bank omylil sie na Twoja krozysc. Otrzymujesz 400$.");
	blueCards[6] = blue6;

	Card* blue7 = new Card(7, "Zajales II miejsce w konkursie pieknosci - otrzymujesz z banku 200$.");
	blueCards[7] = blue7;

	Card* blue8 = new Card(8, "Otrzymujesz roczna rente w wysokosci 200$.");
	blueCards[8] = blue8;

	Card* blue9 = new Card(9, "Bank wyplaci ci nalezne 7% od kapitalow - otrzymujesz 50$.");
	blueCards[9] = blue9;

	Card* blue10 = new Card(10, "Placisz skladke ubezpieczeniowa w wysokosci 20$.");
	blueCards[10] = blue10;

	Card* blue11 = new Card(11, "Z magazynu, w ktorym kupujesz otrzymujesz rabat w wyoskosci 20$.");
	blueCards[11] = blue11;

	Card* blue12 = new Card(12, "Placisz na budowe szpitala 400$.");
	blueCards[12] = blue12;

	Card* blue13 = new Card(13, "Otrzymujesz w spadku 200$.");
	blueCards[13] = blue13;

	Card* blue14 = new Card(14, "Masz urodziny - otrzymujesz od kazdego gracza po 20$.");
	blueCards[14] = blue14;
	...
	Card* red1 = new Card(1, "Piles w czasie pracy, placisz kare 40$.");
	redCards[1] = red1;

	Card* red2 = new Card(2, "Idziesz do wiezienia. Nie przechodzisz przez \"START\". Nie otrzymujesz premii 200$.");
	redCards[2] = red2;

	Card* red3 = new Card(3, "Remontujesz swoje domy. Placisz do banku za kazdy dom 50$, za kazdy hotel 200$.");
	redCards[3] = red3;
	
	Card* red4 = new Card(4, "Cofasz sie o 3 pola.");
	redCards[4] = red4;

	Card* red5 = new Card(5, "Wcyhodzisz wolny z wiezienia. Karte nalezy zachowac do wykorzystania lub sprzedania.");
	redCards[5] = red5;

	Card* red6 = new Card(6, "Idziesz do \"NEAPOLU\". Jezeli przechodzisz przez \"START\" otrzymasz 200$.");
	redCards[6] = red6;

	Card* red7 = new Card(7, "Wracasz do \"Madrytu\"");
	redCards[7] = red7;

	Card* red8 = new Card(8, "Zobowiazany jestes zmodernizowac swoje miasto, placisz do banku za kazdy dom 80$, za kazdy hotel 230$.");
	redCards[8] = red8;

	Card* red9 = new Card(9, "Idziesz do \"KOLEI WSCHODNICH\". Jezeli przechodzisz przez \"START\" otrzymasz 200$.");
	redCards[9] = red9;

	Card* red10 = new Card(10, "Wracasz do \"Brukseli\". Jezeli przechodzisz przez \"START\" otrzymujesz 200$.");
	redCards[10] = red10;

	Card* red11 = new Card(11, "Bank wplaca Ci nalezne odsetkiw  wysokosci 300$.");
	redCards[11] = red11;

	Card* red12 = new Card(12, "Mandat za szybka jazde. Placisz 30$.");
	redCards[12] = red12;

	Card* red13 = new Card(13, "Placisz oplate za szkole 300$.");
	redCards[13] = red13;

	Card* red14 = new Card(14, "Bank wyplaca Ci pprocent w wysokosci 100$.");
	redCards[14] = red14;

	Card* red15 = new Card(15, "Rozwiazales dobrze krzyzowke. Jako I nagrode otrzymujesz 200$.");
	redCards[15] = red15;
